    ...
    def __init__(self, args,c_dim, augment):  
        ...
        if args.model_type == 0:
            ...
            self.g_optim = optim.Adam(
                [{'params' : list(self.encoder_img.parameters()) + list(self.generator.parameters())},
            ...
            self.g_optim = optim.Adam(
                [{'params' : list(self.encoder_img.parameters()) + list(self.edit.parameters()) + list(self.generator.parameters())},
                ],
                lr= args.lr,
                betas=(0, 0.99),
            )
